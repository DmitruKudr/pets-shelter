...
console.log('Оценка 106/110\n\nРеализация burger menu на обеих страницах: +26/26\n\nРеализация слайдера-карусели на странице Main: +36/36\n\nРеализация пагинации на странице Pets: +32/36:\nвыполнил все, кроме этого пункта:\nкарточки питомцев не должны повторяться на одной странице: +4 (на разрешениях меньше 1280 карточки могут повторяться)\n\nРеализация попап на обеих страницах: +12');